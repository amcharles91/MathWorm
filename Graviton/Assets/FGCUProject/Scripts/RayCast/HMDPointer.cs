...
public class HMDPointer : MonoBehaviour {
    ...
    //public float rayDur = 1f;
    ////What can get hit by ray cast
 ...
 //       Debug.DrawLine(transform.position, transform.TransformDirection(transform.forward) * maxRayDistance, Color.red);
